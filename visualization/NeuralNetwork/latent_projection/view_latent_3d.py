...
class LatentSpace3DViewer:
    ...
    def _setup_plotter(self):
        ...
        title = f"Latent Space{model_info} (N={len(self.femur_names)}, dim={self.latents.shape[1]}→3D via {self.method.upper()})"
...
def main():
    ...
    parser.add_argument('-n', '--count', type=int, default=-1,
                       help='Number of femurs to display (default: -1 for all)')
    ...
    all_latents, all_femur_names, model_used = load_projections(args.model)
